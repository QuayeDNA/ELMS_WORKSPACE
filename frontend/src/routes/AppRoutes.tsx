...
const InstitutionDetailsPage = lazy(() => import('@/pages/InstitutionDetailsPage').then(module => ({ default: module.InstitutionDetailsPage })));
...
// Placeholder Pages
const ExamsPage = lazy(() => import('@/pages/admin/PlaceholderPages').then(module => ({ default: module.ExamsPage })));
const IncidentsPage = lazy(() => import('@/pages/admin/PlaceholderPages').then(module => ({ default: module.IncidentsPage })));
const ScriptsPage = lazy(() => import('@/pages/admin/PlaceholderPages').then(module => ({ default: module.ScriptsPage })));
const ReportsPage = lazy(() => import('@/pages/admin/PlaceholderPages').then(module => ({ default: module.ReportsPage })));
const AdminSettingsPage = lazy(() => import('@/pages/admin/PlaceholderPages').then(module => ({ default: module.SettingsPage })));
  ...
  return (
    <Routes>
      ...
      <Route path="/admin/instructors" element={
        <MultiRoleAdminLayout allowedRoles={[UserRole.ADMIN, UserRole.FACULTY_ADMIN, UserRole.DEAN]}>
          <InstructorsPage />
        </MultiRoleAdminLayout>
      } />
