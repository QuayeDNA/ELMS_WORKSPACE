...
export const instructorController = {
  ...
  async getInstructorByStaffId(req: Request, res: Response) {
    try {
      ...
      const instructor = await instructorService.getInstructorByStaffId(staffId);
  ...
  async updateInstructorStatus(req: Request, res: Response) {
    try {
      ...
      const instructor = await instructorService.updateInstructorStatus(id, employmentStatus);
  ...
  async assignToDepartment(req: Request, res: Response) {
    try {
      ...
      const assignment = await instructorService.assignToDepartment(id, departmentId, isPrimary);
      res.json({
        success: true,
