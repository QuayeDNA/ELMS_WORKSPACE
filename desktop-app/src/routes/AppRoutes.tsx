...
import {
  UserManagement as OldUserManagement,
  UserManagement,
} from "../components/users/UserManagement";
...
const RegistryDashboard = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold">Registry Staff Dashboard</h1>
    <p>Coming soon...</p>
  </div>
);
...
const ExternalExaminerDashboard = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold">External Examiner Dashboard</h1>
    <p>Coming soon...</p>
  </div>
);
const VCDashboard = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold">Vice Chancellor Dashboard</h1>
    <p>Coming soon...</p>
  </div>
);
...
const FinanceDashboard = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold">Finance Staff Dashboard</h1>
    <p>Coming soon...</p>
  </div>
);
...
const SecurityDashboard = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold">Security Staff Dashboard</h1>
    <p>Coming soon...</p>
  </div>
);
const MaintenanceDashboard = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold">Maintenance Staff Dashboard</h1>
    <p>Coming soon...</p>
  </div>
);
          ...
          element={
            ...
            >
              <Routes>
                ...
                <Route
                  path="departments"
                  element={<div>Department Management</div>}
                />
                <Route path="staff" element={<OldUserManagement />} />
                <Route
                  path="students"
                  element={<div>Student Management</div>}
                />
              </Routes>
            </ProtectedRoute>
          }
          ...
          element={
            ...
            >
              <Routes>
                ...
                <Route
                  path="supervision"
                  element={<div>Exam Supervision</div>}
                />
              </Routes>
            </ProtectedRoute>
          }
